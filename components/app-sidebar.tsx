  ...
  return (
    <div className="flex h-full flex-col">
      <Link
        href="/dashboard"
        onClick={onNavigate}
        className="flex items-center gap-2 px-4 pb-2 pt-5 text-sm font-semibold tracking-tight text-primary"
      >
        <Logo />
        LoopReady
      </Link>
      ...
      <div className="border-t border-line px-2 py-2">
        ...
        <div className="mt-1 flex items-center gap-2.5 rounded-md px-3 py-2">
          <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border border-line bg-surface text-[11px] font-semibold text-secondary">
            {initials(email)}
          </span>
        ...
        <button
          onClick={signOut}
          className="mt-0.5 block w-full rounded-md px-3 py-1.5 text-left text-sm text-secondary transition-colors hover:bg-elevated hover:text-primary"
        >
          Log out
        </button>
      </div>
  ...
  return (
    <>
      ...
      <div className="sticky top-0 z-40 flex items-center justify-between border-b border-line bg-base/85 px-4 py-3 backdrop-blur lg:hidden">
        <Link href="/dashboard" className="flex items-center gap-2 text-sm font-semibold text-primary">
          <Logo />
          LoopReady
        </Link>
        <button
...
// ---------------------------------------------------------------- icons
// Minimal inline outline icons, matching the existing Logo pattern in
// app-nav.tsx. No icon library is introduced.
